# Cross-Topic Mix Set 147

Coverage Window: topics 001 to 147
Newly Added Since Last Mix: topics 145 to 147
...
### Q1 (Mix 2 Concepts)
Concept Mix: Virtual Private Cloud + Projects And Billing
...
B. Use managed-service-first architecture with least-privilege controls; project-level isolation for IAM, API enablement, quotas, and billing, and enforce least-privilege IAM with automated monitoring and alerts.
...
#### Q1
Scenario Focus: Cross-Topic Mix Set 147
...
#### Q6
Scenario Focus: Cross-Topic Mix Set 147
Two designs both satisfy the happy path for Cross-Topic Mix Set 147. Which choice is most correct?
...
#### Q7
Scenario Focus: Cross-Topic Mix Set 147
What should you validate first before choosing an architecture for Cross-Topic Mix Set 147?

# Cross-Topic Mix Set 078

Coverage Window: topics 001 to 078
Newly Added Since Last Mix: topics 076 to 078

Focus Topics For This Set:
- Cloud Run Functions
- Prompt Engineering Guide
- Architecting Intro
- Getting Started Interacting Gcp
- Cloud Storage Bucket Lab
- Jenkins Marketplace Lab
- Projects And Billing
- Virtual Networks Intro

Question Count: 4
Each question mixes 2 to 5 previously covered concepts.

### Q1 (Mix 2 Concepts)
Concept Mix: Virtual Private Cloud + Cloud Sql
...
B. Use managed-service-first architecture with least-privilege controls; database choice by data model, scale pattern, and consistency requirements, and enforce least-privilege IAM with automated monitoring and alerts.
...
### Q2 (Mix 3 Concepts)
Concept Mix: Cloud Load Balancing + Bigquery + Kubernetes Operations Intro
Scenario: You are deploying a production workload that combines the concepts above. The system must be secure, scalable, and cost-aware while minimizing operations overhead. What is the best approach?
...
Trap: The wrong options either over-privilege access, over-index on one constraint, or increase manual operational risk.
### Q3 (Mix 4 Concepts)
Concept Mix: Storage Overview + Infrastructure Automation Intro + Resource Hierarchy Projects Iam + Containers
Scenario: You are deploying a production workload that combines the concepts above. The system must be secure, scalable, and cost-aware while minimizing operations overhead. What is the best approach?

A. Use storage class and lifecycle policy selected by access frequency and retention; infrastructure-as-code and standardized deployment templates; project-level isolation for IAM, API enablement, quotas, and billing, and enforce least-privilege IAM with automated monitoring and alerts.
...
Trap: The wrong options either over-privilege access, over-index on one constraint, or increase manual operational risk.
### Q4 (Mix 5 Concepts)
Concept Mix: Choosing Hybrid Connectivity + Load Balancing Module Summary + Cloud Sql + Kubernetes Components Control Plane Nodes + Architecting Intro
Scenario: You are deploying a production workload that combines the concepts above. The system must be secure, scalable, and cost-aware while minimizing operations overhead. What is the best approach?

A. Use broad Owner/Editor roles and one shared manual setup to reduce initial effort.
B. Optimize only for short-term cost and ignore latency, reliability, and recovery constraints.
C. Rely on ad-hoc scripts with public exposure defaults and fix controls later.
D. Use private connectivity with HA VPN or Interconnect and correct egress design; correct load balancer type with DNS and edge strategy aligned to traffic pattern; database choice by data model, scale pattern, and consistency requirements, and enforce least-privilege IAM with automated monitoring and alerts.
...
#### Q1
Scenario Focus: Cross-Topic Mix Set 078
...
#### Q6
Scenario Focus: Cross-Topic Mix Set 078
Two designs both satisfy the happy path for Cross-Topic Mix Set 078. Which choice is most correct?
...
#### Q7
Scenario Focus: Cross-Topic Mix Set 078
What should you validate first before choosing an architecture for Cross-Topic Mix Set 078?

...
### Q1
In a Dns Cdn setup, you need low-latency global delivery of static assets. What should you use?
...
### Q2
For Dns Cdn DNS design, what record type is valid for zone apex root domain mapping to a load balancer IP?
...
#### Q6
Scenario Focus: 🌍 Cloud DNS & CDN
Two designs both satisfy the happy path for 🌍 Cloud DNS & CDN. Which choice is most correct?
...
#### Q7
Scenario Focus: 🌍 Cloud DNS & CDN
What should you validate first before choosing an architecture for 🌍 Cloud DNS & CDN?

...
### Q1
In a Kubectl Configuration And Usage cluster, one microservice is CPU-heavy while others are general purpose. How should you optimize?
...
### Q2
A Kubectl Configuration And Usage deployment must be updated with minimal downtime. Which command pattern is best?
...
#### Q6
Scenario Focus: kubectl — Configuration and Usage
Two designs both satisfy the happy path for kubectl — Configuration and Usage. Which choice is most correct?
...
#### Q7
Scenario Focus: kubectl — Configuration and Usage
What should you validate first before choosing an architecture for kubectl — Configuration and Usage?

# Cross-Topic Mix Set 087

Coverage Window: topics 001 to 087
Newly Added Since Last Mix: topics 085 to 087
...
### Q1 (Mix 2 Concepts)
Concept Mix: Virtual Private Cloud + Google Cloud Network And Infrastructure
...
B. Use managed-service-first architecture with least-privilege controls, and enforce least-privilege IAM with automated monitoring and alerts.
...
### Q2 (Mix 3 Concepts)
Concept Mix: Cloud Load Balancing + Dataprep + Bigtable
Scenario: You are deploying a production workload that combines the concepts above. The system must be secure, scalable, and cost-aware while minimizing operations overhead. What is the best approach?

A. Use broad Owner/Editor roles and one shared manual setup to reduce initial effort.
B. Optimize only for short-term cost and ignore latency, reliability, and recovery constraints.
C. Use correct load balancer type with DNS and edge strategy aligned to traffic pattern; analytics pipeline with correct ingest, transform, and warehouse roles; database choice by data model, scale pattern, and consistency requirements, and enforce least-privilege IAM with automated monitoring and alerts.
D. Rely on ad-hoc scripts with public exposure defaults and fix controls later.
...
#### Q1
Scenario Focus: Cross-Topic Mix Set 087
...
#### Q6
Scenario Focus: Cross-Topic Mix Set 087
Two designs both satisfy the happy path for Cross-Topic Mix Set 087. Which choice is most correct?
...
#### Q7
Scenario Focus: Cross-Topic Mix Set 087
What should you validate first before choosing an architecture for Cross-Topic Mix Set 087?
